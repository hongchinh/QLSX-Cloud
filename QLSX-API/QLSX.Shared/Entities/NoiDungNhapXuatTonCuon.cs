...
[Table("NOIDUNGNHAPXUATTONCUON")]
public class NoiDungNhapXuatTonCuon : BaseModel
{
    [Column("IDID")]
    ...
    [Column("NGAYPHIEULSX")]
    public DateTime? NgayInPhieuLSX { get; set; }

    [Column("NhapXuatTonCuonId")]
    public int NhapXuatTonCuonId { get; set; }
}

...
[Table("DANHMUCHANGHOATONCUON")]
public class DanhMucHangHoaTonCuon : BaseModel
{
    [Column("ID")]
    ...
    public double? NguongThongBao { get; set; }
    ...
    public double? NguoiThongBao1 { get; set; }

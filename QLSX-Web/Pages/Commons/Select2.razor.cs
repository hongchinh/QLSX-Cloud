...
namespace QLSX.Web.Commons.Select2 {
    public partial class Select2<TItem, TSource> : ComponentBase where TSource : IEnumerable<TItem> {
        ...
        private const string JS_COMMAND_PREFIX = "Blazor_AdvancedBlazorSelect2Component";
        ...
        public string SelectedItemCode { get; set; } = string.Empty;
        ...
        private object getCacheKey(string id) => new { Namespace = "QLSX.Web.Commons.Select2", Type = "SearchCache", Select2Id = inputGuid, ObjId = id };
        ...
        public async Task OnSelectionChangedAsync(IEnumerable<string> newSelectedIds) {
            ...
            string code = selectedIds.Length > 0 ? selectedIds[0].ToString() : "";

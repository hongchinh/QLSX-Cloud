...
namespace QLSX.Web.Services
{
    interface IDMDoDayService<T>
    {
        ...
        Task<GetAllResponsePaged<DanhMucDoDayModel>> GetAllPagedAsync(QLSX.Shared.Models.BaseSearchRequest request);

    }

    public class DMDoDayService<T> : IDMDoDayService<T>
    {
        public HttpClient _httpClient { get; }
        public AppSettings _appSettings { get; }
        public AppService _appService { get; }
        public ILocalStorageService _localStorageService { get; }
        private string requestUri = "DMDoDays";
        public DMDoDayService(HttpClient httpClient
        ...
        public async Task<GetAllResponsePaged<DanhMucDoDayModel>> GetAllPagedAsync(QLSX.Shared.Models.BaseSearchRequest request)
        {
            ...
            {
                var responseBody = await response.Content.ReadAsStringAsync();
                return await Task.FromResult(JsonConvert.DeserializeObject<GetAllResponsePaged<DanhMucDoDayModel>>(responseBody));
            }
            else
                return new();
        }

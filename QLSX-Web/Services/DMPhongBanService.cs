...
{
    interface IDMPhongBanService<T>
    {
        Task<List<T>> GetAllAsync();
        Task<List<T>> GetAllByRegionIdAsync(int RegionId);
        Task<T> GetByIdAsync(int Id);
        Task<T> CreateAsync(T obj);
        Task<T> UpdateAsync(int Id, T obj);
        Task<bool> DeleteAsync(int Id);

        public Task<GetAllResponsePaged<QLSX.Shared.Models.DMPhongBan>> ExportToExcelAsync(QLSX.Shared.Models.BaseSearchRequest request);
        public Task<GetAllResponsePaged<QLSX.Shared.Models.DMPhongBan>> GetAllPagedAsync(QLSX.Shared.Models.BaseSearchRequest request);


    }

    public class DMPhongBanService<T> : IDMPhongBanService<T>
    {
        public HttpClient _httpClient { get; }
        public AppSettings _appSettings { get; }
        public AppService _appService;
        public ILocalStorageService _localStorageService { get; }
        private string requestUri = "DMPhongBans";
        public DMPhongBanService(HttpClient httpClient
        ...
        public async Task<List<T>> GetAllByRegionIdAsync(int RegionId)
        {
            var requestMessage = new HttpRequestMessage(HttpMethod.Get, requestUri + "/GetAllByRegionId/" + RegionId);
        ...
        public async Task<GetAllResponsePaged<QLSX.Shared.Models.DMPhongBan>> GetAllPagedAsync(QLSX.Shared.Models.BaseSearchRequest request)
        {
            ...
            {
                var responseBody = await response.Content.ReadAsStringAsync();
                return await Task.FromResult(JsonConvert.DeserializeObject<GetAllResponsePaged<QLSX.Shared.Models.DMPhongBan>>(responseBody));
            }
            else
                return new();
        }
        public async Task<GetAllResponsePaged<QLSX.Shared.Models.DMPhongBan>> ExportToExcelAsync(QLSX.Shared.Models.BaseSearchRequest request)
        {
            string serializedUser = JsonConvert.SerializeObject(request);

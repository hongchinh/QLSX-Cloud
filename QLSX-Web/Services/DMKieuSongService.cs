...
{
    interface IDMKieuSongService<T>
    {
        ...
        Task<GetAllResponsePaged<DanhMucKieuSongModel>> GetAllPagedAsync(QLSX.Shared.Models.BaseSearchRequest request);

    }

    public class DMKieuSongService<T> : IDMKieuSongService<T>
    {
        public HttpClient _httpClient { get; }
        public AppSettings _appSettings { get; }
        public AppService _appService { get; }
        public ILocalStorageService _localStorageService { get; }
        private string requestUri = "DMKieuSongs";
        public DMKieuSongService(HttpClient httpClient
        ...
        public async Task<GetAllResponsePaged<DanhMucKieuSongModel>> GetAllPagedAsync(QLSX.Shared.Models.BaseSearchRequest request)
        {
            ...
            {
                var responseBody = await response.Content.ReadAsStringAsync();
                return await Task.FromResult(JsonConvert.DeserializeObject<GetAllResponsePaged<DanhMucKieuSongModel>>(responseBody));
            }
            else
                return new();
        }

...
using QLSX.Web.Models.Bots.Tasks;
...
namespace QLSX.Web.Services.Bots
{
    public class ChatEngine
    {
        Dictionary<Guid, Models.Bots.ChatContext> Sessions = new Dictionary<Guid, Models.Bots.ChatContext>();

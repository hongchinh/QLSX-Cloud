...
{
    interface IDMTinhTrangService<T>
    {
    ...
    public class DMTinhTrangService<T> : IDMTinhTrangService<T>
    {
        public HttpClient _httpClient { get; }
        public AppSettings _appSettings { get; }
        public AppService _appService { get; }
        public ILocalStorageService _localStorageService { get; }
        private string requestUri = "DMTinhTrangs";
        public DMTinhTrangService(HttpClient httpClient

...
{
    interface IDMNhomKhachHangService<T>
    {
        Task<List<T>> GetAllAsync();
        Task<T> GetByIdAsync(int Id);
        Task<DanhMucNhomKhachHangModel> GetByCodeAsync(string code);
        Task<T> CreateAsync(T obj);
        Task<T> UpdateAsync(int Id, T obj);
        Task<bool> DeleteAsync(int Id);

        Task<GetAllResponsePaged<DanhMucNhomKhachHangModel>> ExportToExcelAsync(QLSX.Shared.Models.BaseSearchRequest request);
        Task<GetAllResponsePaged<DanhMucNhomKhachHangModel>> GetAllPagedAsync(QLSX.Shared.Models.BaseSearchRequest request);
        Task<bool> UpdateListPrintAsync(List<int> request);
    }

    public class DMNhomKhachHangService<T> : IDMNhomKhachHangService<T>
    {
        public HttpClient _httpClient { get; }
        public AppSettings _appSettings { get; }
        public AppService _appService { get; }
        public ILocalStorageService _localStorageService { get; }
        private string requestUri = "DMNhomKhachHangs";
        public DMNhomKhachHangService(HttpClient httpClient
        ...
        public async Task<DanhMucNhomKhachHangModel> GetByCodeAsync(string code)
        {
            ...
            try
            {
                return await Task.FromResult(JsonConvert.DeserializeObject<DanhMucNhomKhachHangModel>(responseBody));
            }
            catch (Exception)
            {
                return new();
        ...
        public async Task<GetAllResponsePaged<DanhMucNhomKhachHangModel>> GetAllPagedAsync(QLSX.Shared.Models.BaseSearchRequest request)
        {
            ...
            {
                var responseBody = await response.Content.ReadAsStringAsync();
                return await Task.FromResult(JsonConvert.DeserializeObject<GetAllResponsePaged<DanhMucNhomKhachHangModel>>(responseBody));
            }
            else
                return new();
        }
        public async Task<GetAllResponsePaged<DanhMucNhomKhachHangModel>> ExportToExcelAsync(QLSX.Shared.Models.BaseSearchRequest request)
        {
            string serializedUser = JsonConvert.SerializeObject(request);
        ...
        public async Task<bool> UpdateListPrintAsync(List<int> request)
        {
            ...
            var requestMessage = new HttpRequestMessage(HttpMethod.Post, "BaoCaos/UpdateListPrint/NhomKhachHang");

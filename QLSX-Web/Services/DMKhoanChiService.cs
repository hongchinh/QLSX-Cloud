...
{
    interface IDMKhoanChiService<T>
    {
        Task<List<T>> GetAllAsync();
        Task<T> GetByIdAsync(int Id);
        Task<DanhMucKhoanChiModel> GetByCodeAsync(string code);
        Task<T> CreateAsync(T obj);
        Task<T> UpdateAsync(int Id, T obj);
        Task<bool> DeleteAsync(int Id);
        Task<GetAllResponsePaged<DanhMucKhoanChiModel>> GetAllPagedAsync(QLSX.Shared.Models.BaseSearchRequest request);
        Task<GetAllResponsePaged<DanhMucKhoanChiModel>> ExportToExcelAsync(QLSX.Shared.Models.BaseSearchRequest request);
    }

    public class DMKhoanChiService<T> : IDMKhoanChiService<T>
    {
        public HttpClient _httpClient { get; }
        public AppSettings _appSettings { get; }
        public AppService _appService { get; }
        public ILocalStorageService _localStorageService { get; }
        private string requestUri = "DMKhoanChis";
        public DMKhoanChiService(HttpClient httpClient
        ...
        public async Task<DanhMucKhoanChiModel> GetByCodeAsync(string code)
        {
            ...
            try
            {
                return await Task.FromResult(JsonConvert.DeserializeObject<DanhMucKhoanChiModel>(responseBody));
            }
            catch (Exception)
            {
                return new();
        ...
        public async Task<GetAllResponsePaged<DanhMucKhoanChiModel>> GetAllPagedAsync(QLSX.Shared.Models.BaseSearchRequest request)
        {
            ...
            {
                var responseBody = await response.Content.ReadAsStringAsync();
                return await Task.FromResult(JsonConvert.DeserializeObject<GetAllResponsePaged<DanhMucKhoanChiModel>>(responseBody));
            }
            else
                return new();
        }
        public async Task<GetAllResponsePaged<DanhMucKhoanChiModel>> ExportToExcelAsync(QLSX.Shared.Models.BaseSearchRequest request)
        {
            string serializedUser = JsonConvert.SerializeObject(request);

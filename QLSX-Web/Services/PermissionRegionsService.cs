...
{
    interface IPermissionRegionsService<T>
    {
    ...
    public class PermissionRegionsService<T> : IPermissionRegionsService<T>
    {
        public HttpClient _httpClient { get; }
        public AppSettings _appSettings { get; }
        public AppService _appService;
        public ILocalStorageService _localStorageService { get; }
        private string requestUri = "PermissionRegions";
        public PermissionRegionsService(HttpClient httpClient

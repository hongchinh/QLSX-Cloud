...
{
    interface IDMKhoanThuService<T>
    {
        Task<List<T>> GetAllAsync();
        Task<T> GetByIdAsync(int Id);
        Task<T> CreateAsync(T obj);
        Task<DanhMucKhoanThuModel> GetByCodeAsync(string code);
        Task<T> UpdateAsync(int Id, T obj);
        Task<bool> DeleteAsync(int Id);
        Task<GetAllResponsePaged<DanhMucKhoanThuModel>> GetAllPagedAsync(QLSX.Shared.Models.BaseSearchRequest request);
        Task<GetAllResponsePaged<DanhMucKhoanThuModel>> ExportToExcelAsync(QLSX.Shared.Models.BaseSearchRequest request);
    }

    public class DMKhoanThuService<T> : IDMKhoanThuService<T>
    {
        public HttpClient _httpClient { get; }
        public AppSettings _appSettings { get; }
        public AppService _appService { get; }
        public ILocalStorageService _localStorageService { get; }
        private string requestUri = "DMKhoanThus";
        public DMKhoanThuService(HttpClient httpClient
        ...
        public async Task<DanhMucKhoanThuModel> GetByCodeAsync(string code)
        {
            ...
            try
            {
                return await Task.FromResult(JsonConvert.DeserializeObject<DanhMucKhoanThuModel>(responseBody));
            }
            catch (Exception)
            {
                return new();
        ...
        public async Task<GetAllResponsePaged<DanhMucKhoanThuModel>> GetAllPagedAsync(QLSX.Shared.Models.BaseSearchRequest request)
        {
            ...
            {
                var responseBody = await response.Content.ReadAsStringAsync();
                return await Task.FromResult(JsonConvert.DeserializeObject<GetAllResponsePaged<DanhMucKhoanThuModel>>(responseBody));
            }
            else
                return new();
        }
        public async Task<GetAllResponsePaged<DanhMucKhoanThuModel>> ExportToExcelAsync(QLSX.Shared.Models.BaseSearchRequest request)
        {
            string serializedUser = JsonConvert.SerializeObject(request);

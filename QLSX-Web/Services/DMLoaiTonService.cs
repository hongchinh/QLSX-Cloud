...
namespace QLSX.Web.Services
{
    interface IDMLoaiTonService<T>
    {
        ...
        Task<GetAllResponsePaged<DanhMucLoaiTonModel>> GetAllPagedAsync(QLSX.Shared.Models.BaseSearchRequest request);

    }

    public class DMLoaiTonService<T> : IDMLoaiTonService<T>
    {
        public HttpClient _httpClient { get; }
        public AppSettings _appSettings { get; }
        public AppService _appService { get; }
        public ILocalStorageService _localStorageService { get; }
        private string requestUri = "DMLoaiTons";
        public DMLoaiTonService(HttpClient httpClient
        ...
        public async Task<GetAllResponsePaged<DanhMucLoaiTonModel>> GetAllPagedAsync(QLSX.Shared.Models.BaseSearchRequest request)
        {
            ...
            {
                var responseBody = await response.Content.ReadAsStringAsync();
                return await Task.FromResult(JsonConvert.DeserializeObject<GetAllResponsePaged<DanhMucLoaiTonModel>>(responseBody));
            }
            else
                return new();
        }

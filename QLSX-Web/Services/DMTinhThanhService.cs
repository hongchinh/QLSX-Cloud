...
{
    interface IDMTinhThanhService<T>
    {
    ...
    public class DMTinhThanhService<T> : IDMTinhThanhService<T>
    {
        public HttpClient _httpClient { get; }
        public AppSettings _appSettings { get; }
        public AppService _appService { get; }
        public ILocalStorageService _localStorageService { get; }
        private string requestUri = "DMTinhThanhs";
        public DMTinhThanhService(HttpClient httpClient

...
namespace QLSX.Web.Services
{
    interface IDMMauSacService<T>
    {
        ...
        Task<GetAllResponsePaged<DanhMucMauSacModel>> GetAllPagedAsync(QLSX.Shared.Models.BaseSearchRequest request);

    }

    public class DMMauSacService<T> : IDMMauSacService<T>
    {
        public HttpClient _httpClient { get; }
        public AppSettings _appSettings { get; }
        public AppService _appService { get; }
        public ILocalStorageService _localStorageService { get; }
        private string requestUri = "DMMauSacs";
        public DMMauSacService(HttpClient httpClient
        ...
        public async Task<GetAllResponsePaged<DanhMucMauSacModel>> GetAllPagedAsync(QLSX.Shared.Models.BaseSearchRequest request)
        {
            ...
            {
                var responseBody = await response.Content.ReadAsStringAsync();
                return await Task.FromResult(JsonConvert.DeserializeObject<GetAllResponsePaged<DanhMucMauSacModel>>(responseBody));
            }
            else
                return new();
        }

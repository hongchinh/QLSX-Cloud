...
namespace QLSX.Web.Services
{
    interface IDMTinhGiaService<T>
    {
        ...
        public Task<GetAllResponsePaged<QLSX.Shared.Models.DMTinhGia>> GetAllPagedAsync(QLSX.Shared.Models.BaseRequest request);

    }

    public class DMTinhGiaService<T> : IDMTinhGiaService<T>
    {
        public HttpClient _httpClient { get; }
        public AppSettings _appSettings { get; }
        public AppService _appService { get; }
        public ILocalStorageService _localStorageService { get; }
        private string requestUri = "DMTinhGias";
        public DMTinhGiaService(HttpClient httpClient
        ...
        public async Task<GetAllResponsePaged<DMTinhGia>> GetAllPagedAsync(QLSX.Shared.Models.BaseRequest request)
        {
            ...
            {
                var responseBody = await response.Content.ReadAsStringAsync();
                return await Task.FromResult(JsonConvert.DeserializeObject<GetAllResponsePaged<QLSX.Shared.Models.DMTinhGia>>(responseBody));
            }
            else
                return new();
        }

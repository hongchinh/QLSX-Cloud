...
{
    interface ICustomerCareService<T>
    {
        Task<List<T>> GetAllAsync();
        Task<T> GetByIdAsync(int Id);

        Task<List<T>> GetByCustomerIdAsync(int Id);
    ...
    public class CustomerCareService<T> : ICustomerCareService<T>
    {
        public HttpClient _httpClient { get; }
        public AppSettings _appSettings { get; }
        public ILocalStorageService _localStorageService { get; }
        public AppService _appService;
        private string requestUri = "customercares";
        public CustomerCareService(HttpClient httpClient
        ...
        public async Task<List<T>> GetByCustomerIdAsync(int Id)
        {
            var requestMessage = new HttpRequestMessage(HttpMethod.Get, requestUri + "/GetByCustomerId/" + Id);

...
{
    interface IDMDonViSuDungUserService<T>
    {
        Task<List<T>> GetAllAsync();
        Task<List<T>> GetPermissionAsync(PermissionVM obj);
        Task<T> GetByIdAsync(int Id);
        Task<T> CreateAsync(PermissionRequest obj);
        Task<T> UpdateAsync(int Id, PermissionRequest obj);
        Task<bool> DeleteAsync(int Id);
    }

    public class DMDonViSuDungUserService<T> : IDMDonViSuDungUserService<T>
    {
        ...
        private string requestUri = "DMDonViSuDungUsers";
        public DMDonViSuDungUserService(HttpClient httpClient
        ...
        public async Task<List<T>> GetPermissionAsync(PermissionVM obj)
        {
            string serializedUser = JsonConvert.SerializeObject(obj);

            var requestMessage = new HttpRequestMessage(HttpMethod.Get, requestUri + "/GetPermission");
        ...
        public async Task<T> CreateAsync(PermissionRequest obj)
        {
            string serializedUser = JsonConvert.SerializeObject(obj);
        ...
        public async Task<T> UpdateAsync(int Id, PermissionRequest obj)
        {
            string serializedUser = JsonConvert.SerializeObject(obj);

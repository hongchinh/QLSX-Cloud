...
{
    interface IPermissionDepartmentsService<T>
    {
    ...
    public class PermissionDepartmentsService<T> : IPermissionDepartmentsService<T>
    {
        public HttpClient _httpClient { get; }
        public AppSettings _appSettings { get; }
        public ILocalStorageService _localStorageService { get; }
        public AppService _appService;
        private string requestUri = "PermissionDepartments";
        public PermissionDepartmentsService(HttpClient httpClient

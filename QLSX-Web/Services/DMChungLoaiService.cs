...
{
    interface IDMChungLoaiService<T>
    {
        ...
        Task<GetAllResponsePaged<DanhMucChungLoaiModel>> GetAllPagedAsync(QLSX.Shared.Models.BaseSearchRequest request);

    }

    public class DMChungLoaiService<T> : IDMChungLoaiService<T>
    {
        public HttpClient _httpClient { get; }
        public AppSettings _appSettings { get; }
        public AppService _appService { get; }
        public ILocalStorageService _localStorageService { get; }
        private string requestUri = "DMChungLoais";
        public DMChungLoaiService(HttpClient httpClient
        ...
        public async Task<GetAllResponsePaged<DanhMucChungLoaiModel>> GetAllPagedAsync(QLSX.Shared.Models.BaseSearchRequest request)
        {
            ...
            {
                var responseBody = await response.Content.ReadAsStringAsync();
                return await Task.FromResult(JsonConvert.DeserializeObject<GetAllResponsePaged<DanhMucChungLoaiModel>>(responseBody));
            }
            else
                return new();
        }

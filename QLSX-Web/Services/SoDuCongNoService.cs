...
{
    interface ISoDuCongNoService<T>
    {
        Task<List<T>> GetAllAsync();
        Task<List<T>> GetAllAsync(QLSX.Shared.Models.SearchSoDuCongNoRequest request);
    ...
    public class SoDuCongNoService<T> : ISoDuCongNoService<T>
    {
        ...
        private string requestUri = "soducongno";
        public SoDuCongNoService(HttpClient httpClient
        ...
        public async Task<List<T>> GetAllAsync(QLSX.Shared.Models.SearchSoDuCongNoRequest request)
        {

...
{
    interface ISoDuHangHoaService<T>
    {
        Task<List<T>> GetAllAsync();
        Task<List<T>> GetAllByMaKhoAsync(QLSX.Shared.Models.SearchSoDuHangHoaRequest request);
        Task<T> GetByIdAsync(int Id);
        Task<T> CreateAsync(T obj);
        Task<T> UpdateAsync(int Id, T obj);
        Task<T> CreateBatchAsync(List<T> obj);
        Task<T> UpdateBatchAsync(List<T> obj);
        Task<bool> DeleteAsync(int Id);
    }

    public class SoDuHangHoaService<T> : ISoDuHangHoaService<T>
    {
        ...
        private string requestUri = "soduhanghoa";
        public SoDuHangHoaService(HttpClient httpClient
        ...
        public async Task<List<T>> GetAllByMaKhoAsync(QLSX.Shared.Models.SearchSoDuHangHoaRequest request)
        {
        ...
        public async Task<T> CreateBatchAsync(List<T> obj)
        {
            string serializedUser = JsonConvert.SerializeObject(obj);

            var requestMessage = new HttpRequestMessage(HttpMethod.Post, requestUri + "/createbatch");
        ...
        public async Task<T> UpdateBatchAsync(List<T> obj)
        {
            string serializedUser = JsonConvert.SerializeObject(obj);

            var requestMessage = new HttpRequestMessage(HttpMethod.Put, requestUri + "/updatebatch" );
            var token = await _localStorageService.GetItemAsync<string>("accessToken");
            requestMessage.Headers.Authorization
                = new System.Net.Http.Headers.AuthenticationHeaderValue("Bearer", token);

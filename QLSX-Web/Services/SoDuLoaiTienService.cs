...
{
    interface ISoDuLoaiTienService<T>
    {
        Task<List<T>> GetAllAsync();
        Task<List<T>> GetAllAsync(QLSX.Shared.Models.SearchSoDuLoaiTienRequest request);
    ...
    public class SoDuLoaiTienService<T> : ISoDuLoaiTienService<T>
    {
        ...
        private string requestUri = "soduloaitien";
        public SoDuLoaiTienService(HttpClient httpClient
        ...
        public async Task<List<T>> GetAllAsync(QLSX.Shared.Models.SearchSoDuLoaiTienRequest request)
        {

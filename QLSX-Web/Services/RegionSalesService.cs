...
{
    interface IRegionSalesService<T>
    {
    ...
    public class RegionSalesService<T> : IRegionSalesService<T>
    {
        public HttpClient _httpClient { get; }
        public AppSettings _appSettings { get; }
        public ILocalStorageService _localStorageService { get; }
        private string requestUri = "RegionSales";
        public AppService _appService;
        public RegionSalesService(HttpClient httpClient

...
{
    interface IDMHangHoaTonCuonService<T>
    {
        ...
        Task<GetAllResponsePaged<DanhMucHangHoaTonCuonModel>> ExportToExcelAsync(QLSX.Shared.Models.HangHoaTonCuonSearchRequest request);
        Task<GetAllResponsePaged<DanhMucHangHoaTonCuonModel>> GetAllPagedAsync(QLSX.Shared.Models.HangHoaTonCuonSearchRequest request);
        Task<GetAllResponsePaged<DanhMucHangHoaTonCuonModel>> GetAllPagedDialogAsync(QLSX.Shared.Models.HangHoaTonCuonSearchRequest request);

    }

    public class DMHangHoaTonCuonService<T> : IDMHangHoaTonCuonService<T>
    {
        ...
        string requestUri = "DmHangHoaTonCuons";
        public DMHangHoaTonCuonService(HttpClient httpClient
        ...
        public async Task<List<T>> GetAllAsync()
        {
            ...
            //var responseManagement = await _apiServices.SendApiPostAsync<GetUserManagementRequest, GetUserManagementResponse>(requestManagement);
        ...
        public async Task<GetAllResponsePaged<DanhMucHangHoaTonCuonModel>> GetAllPagedAsync(QLSX.Shared.Models.HangHoaTonCuonSearchRequest request)
        {
            ...
            {
                var responseBody = await response.Content.ReadAsStringAsync();
                return await Task.FromResult(JsonConvert.DeserializeObject<GetAllResponsePaged<DanhMucHangHoaTonCuonModel>>(responseBody));
            }
            else
                return new();
        }
        public async Task<GetAllResponsePaged<DanhMucHangHoaTonCuonModel>> ExportToExcelAsync(QLSX.Shared.Models.HangHoaTonCuonSearchRequest request)
        {
            request.DMDonViSuDungId = _appService.DMDonViSuDungId;
            string serializedUser = JsonConvert.SerializeObject(request);
        ...
        public async Task<GetAllResponsePaged<DanhMucHangHoaTonCuonModel>> GetAllPagedDialogAsync(QLSX.Shared.Models.HangHoaTonCuonSearchRequest request)
        {
            request.DMDonViSuDungId = _appService.DMDonViSuDungId;
            string serializedUser = JsonConvert.SerializeObject(request);

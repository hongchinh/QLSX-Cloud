...
{
    interface IDMLoaiTienService<T>
    {
        ...
        Task<GetAllResponsePaged<DanhMucLoaiTienModel>> ExportToExcelAsync(QLSX.Shared.Models.BaseSearchRequest request);
        Task<GetAllResponsePaged<DanhMucLoaiTienModel>> GetAllPagedAsync(QLSX.Shared.Models.BaseSearchRequest request);
    }

    public class DMLoaiTienService<T> : IDMLoaiTienService<T>
    {
        public HttpClient _httpClient { get; }
        public AppSettings _appSettings { get; }
        public AppService _appService { get; }
        public ILocalStorageService _localStorageService { get; }
        private string requestUri = "DMLoaiTiens";
        public DMLoaiTienService(HttpClient httpClient
        ...
        public async Task<GetAllResponsePaged<DanhMucLoaiTienModel>> GetAllPagedAsync(QLSX.Shared.Models.BaseSearchRequest request)
        {
            ...
            {
                var responseBody = await response.Content.ReadAsStringAsync();
                return await Task.FromResult(JsonConvert.DeserializeObject<GetAllResponsePaged<DanhMucLoaiTienModel>>(responseBody));
            }
            else
                return new();
        }
        public async Task<GetAllResponsePaged<DanhMucLoaiTienModel>> ExportToExcelAsync(QLSX.Shared.Models.BaseSearchRequest request)
        {
            string serializedUser = JsonConvert.SerializeObject(request);
